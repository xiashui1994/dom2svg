 ...
 */
export function doRectanglesIntersect(a: DOMRectReadOnly, b: DOMRectReadOnly): boolean {
  return !(
 ...
 */
export function isTaggedUnionMember<T extends object, K extends keyof T, V extends T[K]>(key: K, value: V) {
  return (
    object: T,
